...
| ------------ | ------------------ | ----------------------------------------------------------------------------------------- |
| dateFormat   | `GanttDateFormat`  | format de date                                                                            |
| dateOptions  | `GanttDateOptions` | Configuration de la date, qui peut être utilisée pour configurer le fuseau horaire global |
| linkOptions  | `GanttLinkOptions` | Configuration des relations                                                               |
| styleOptions | `GanttStyles`      | Configuration des styles                                                                  |
